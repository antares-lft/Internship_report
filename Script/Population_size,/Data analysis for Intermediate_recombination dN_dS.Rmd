...
folder <- "/home/alafitte/Internship/Rapport de stage/Données/Population_size/Intermediate_recombination/N100"
...
ggplot(combined_data, aes(x = species, y = dnds)) +
  ...
  ylab("dN/dS") +
  ylim(0, 2) +
  xlab("Branches in number of generations") +
...
# Dossier pour N = 100
N <- 100
folder <- "/home/alafitte/Internship/Rapport de stage/Données/Population_size/Low_recombination/N100"
files <- file.path(folder, sprintf("resultats_final_%02d.csv", 1:20))
...
# Fichier de sortie
csv_output <- "/home/alafitte/Internship/Rapport de stage/Données/Population_size/Low_recombination/Mean_dN_dS.csv"
...
folder <- "/home/alafitte/Internship/Rapport de stage/Données/Population_size/Intermediate_recombination/N250"
files <- file.path(folder, sprintf("resultats_final_%02d.csv", 1:20))
...
folder <- "/home/alafitte/Internship/Rapport de stage/Données/Population_size/Intermediate_recombination/N500"
files <- file.path(folder, sprintf("resultats_final_%02d.csv", 1:20))
...
folder <- "/home/alafitte/Internship/Rapport de stage/Données/Population_size/Intermediate_recombination/N1000"
files <- file.path(folder, sprintf("resultats_final_%02d.csv", 3:20))
...
folder <- "/home/alafitte/Internship/Rapport de stage/Données/Population_size/Intermediate_recombination/N2500"
files <- file.path(folder, sprintf("resultats_final_%02d.csv", 1:20))
...
folder <- "/home/alafitte/Internship/Rapport de stage/Données/Population_size/Intermediate_recombination/N5000"
files <- file.path(folder, sprintf("resultats_final_%02d.csv", 1:20))
